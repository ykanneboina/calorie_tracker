            ...
            <div class= "header">
                <div class="pull-right">
                   <ul class="nav nav-pills">
                       <li>
                            <a class= "green white" href="try.php">All</a>
                        </li>
                        <li>
                            <a class= "green white" href="breakfast.php">Breakfast</a>
                        </li>
                        <li>
                            <a class= "green white" href="lunch.php">Lunch</a>
                        </li>
                        <li>
                            <a class= "green white" href="snacks.php">Snacks</a>
                        </li>
                        <li>
                            <a class= "green white" href="drinks.php">Drinks</a>
                        </li>
                        <li>
                            <a class= "green white" href="about.php">About</a>
                        </li>
                    </ul>
                </div>  
