...
$total_calories1 = round($total_calories);
echo "<br>";
echo "<br>";
...
echo "<br>";
echo "<br>";
echo "You have burned {$burned_calories1} calories.";
echo "<br>";
echo "<br>";
echo "In total, your net calorie intake for the day is {$total_calories1} calories.";
echo "<br>";
echo "<br>";
echo "This means that you ate {$total_percentage_rounded}% of your recommended calorie intake.";
echo "<br>";
echo "<br>";
